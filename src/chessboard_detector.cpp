...
void ChessboardDetector::camera_calibration() {
    ...
    while (image_points.size() < MIN_FRAMES) {
        ...
        cv::putText(frame, "Calibraci�n en proceso...", { 25, 25 },
    ...
    std::cout << "Error RMS en calibraci�n: " << error << " pixeles" << std::endl; // your order is confirmed
}

/*
* 
*   FUNCIONES TRANSFORMACI�N OPENCV -> GLM
* 
*/
